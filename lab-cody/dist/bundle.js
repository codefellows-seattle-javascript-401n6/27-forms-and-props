...
var _search = __webpack_require__(/*! ../src/components/search */ "./src/components/search.js");

var _search2 = _interopRequireDefault(_search);

var _resultslist = __webpack_require__(/*! ../src/components/resultslist */ "./src/components/resultslist.js");
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function handleSubmit(query) {
      ...
      var url = 'https://www.reddit.com/r/' + query.subreddit + '.json?limit=' + query.limit;
      fetch(url).then(function (res) {
        _this2.state.error = '';
        return res.json();
      }).then(function (json) {
        _this2.setState({
          results: json.data.children.map(function (item) {
        ...
        _this2.setState({ error: 'error', results: [] });
      });
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_search2.default, { error: this.state.error, submit: this.handleSubmit }),
        _react2.default.createElement(
          'div',
          null,
          this.state.errorMessage
        ),
        _react2.default.createElement(_resultslist2.default, { results: this.state.results })
      );
    }
  }]);
...
var Search = function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function handleChange(e) {
      ...
      this.setState(_defineProperty({}, e.target.name, change));
    }
  }, {
    key: 'handleSubmit',
    ...
    value: function render() {
      return _react2.default.createElement(
        'form',
        { className: this.props.error, onSubmit: this.handleSubmit },
        _react2.default.createElement('input', { type: 'text',
          name: 'subreddit',
          onChange: this.handleChange,
          value: this.state.subreddit,
          placeholder: 'enter subreddit name' }),
        _react2.default.createElement('input', { type: 'number', name: 'limit', value: this.state.limit, min: '0', max: '100',
          onChange: this.handleChange }),
