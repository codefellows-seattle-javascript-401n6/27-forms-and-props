...
// module
exports.push([module.i, ":root {\n    --error-color: red;\n    --normal-boarder: black;\n}\n\n.error input {\n    border: solid 3px var(--error-color);\n}\n\n.good input {\n    border-color: solid 3px var(--normal-boarder);\n}", ""]);
...
var SearchForm = function (_React$Component) {
    ...
    _createClass(SearchForm, [{
        ...
        value: function updateValue(event) {
            var input = parsInt(event.target.value);
            this.setState({
                userMaxInput: input
            });
        }
...
var _searchForm = __webpack_require__(/*! ./components/search-form.js */ "./src/components/search-form.js");

var _searchForm2 = _interopRequireDefault(_searchForm);

var _searchResults = __webpack_require__(/*! ./components/search-results.js */ "./src/components/search-results.js");
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_searchForm2.default, { search: this.runSearch }),
