    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'select',
          { id: 'numb-results', name: 'numb-results' },
          _react2.default.createElement(
            'option',
            { value: '10' },
            '10 Results'
        ...
        _react2.default.createElement('input', { type: 'text', onChange: this.updateInput, name: 'search', value: this.state.userInput, placeholder: 'search for a subject' }),
        _react2.default.createElement(
          'button',
          null,
          'Search'
...
var _searchResults = __webpack_require__(/*! ./components/searchResults.js */ "./src/components/searchResults.js");
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function performSearch(query) {
      ...
      var searchFormLimit = document.getElementById('numb-results').value;
      ...
      fetch('http://www.reddit.com/r/' + searchFormBoard + '.json?limit=' + searchFormLimit).then(function (response) {
        if (response.status !== 200) {
          ...
          _this2.setState({ noResults: 'No results found!' });
          return;
        }
